...
- givenSamples_whenContainsValues_thenReturnRangeAndCount is the name of a **passing** test
- void givenSamples_whenContainsNull_thenReturnNull, void givenSample_whenEmpty_thenReturnNull of a **failing** test
